...
import type { Activity, ActivityType, BreadcrumbItem, Topic } from '@/types';
...
export default function ActivitiesEdit({
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: activity.name, href: ActivityController.edit.url(activity) },
    ];
    ...
    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-6 p-6">
                <PageHeader title={`Editar: ${activity.name}`}>
