...
import type { Activity, BreadcrumbItem, Product } from '@/types';

type Props = { product: Product; activities: Pick<Activity, 'id' | 'name'>[] };

export default function ProductsEdit({ product, activities }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Productos', href: ProductController.index.url() },
        { title: product.name, href: ProductController.edit.url(product) },
    ];
